...
namespace TaskManagement.Controllers
{
    ...
    public class TaskController : Controller
    {
        ...
        {
            // Fetch task data along with related entities (assigned user, project, user story)
        ...
        [HttpPost]
        public IActionResult Create(FileTask mstrTask)
        ...
        //{
        //    var task = db.MstrTasks.FirstOrDefault(x => x.TaskId == id);
        //    if (task != null)
        //    {
        //        task.Status = false;
